    ...
    try:
        ...
        try:
            ...
            if receipt.logs:
                ...
                print(f" No events emitted (might be normal)")
            ...
            try:
                ...
                if not is_registered:
                    ...
                    print(f" Waiting a bit longer and retrying...")
                    time.sleep(1)
        ...
        try:
            ...
            print(f" Warning: Could not store face encoding locally: {e}")
    ...
    try:
        ...
        try:
            ...
            if not is_registered:
                ...
                if local_user:
                    print(f" User exists in local database but not on blockchain!")
        ...
        try:
            ...
            if stored_encoding_obj:
                ...
                print(" No stored encoding found, using hash comparison (less reliable)")
